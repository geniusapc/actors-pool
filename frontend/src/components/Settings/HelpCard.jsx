    ...
    return (
        <div className="shadow-3xl flex  flex-col  rounded-lg py-5 px-7 ">
            ...
            <ul className="space-y-4 ">
                <li className="flex justify-between text-gray300 cursor-pointer" onClick={() => navigate("/contact-us")}>
                    Contact us <ArrrowNextIcon />
                </li>
                <li className="flex justify-between text-gray300 cursor-pointer" onClick={() => navigate("/faq")}>
                    Frequently asked questions <ArrrowNextIcon />
                </li>
                <li className="flex justify-between text-gray300 cursor-pointer" onClick={() => navigate("/terms-and-conditions")}>
